...
const Footer = () => {
  return (
    <div className="dark:bg-gray-800 dark:text-white bg-slate-200 flex items-center justify-evenly">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 ">
      <div className="mt-10 mb-10 text-center lg:text-left">
        <h1 className="text-3xl font-bold">Daily News</h1>
        <p className="dark:text-white text-slate-800 font-sans">Building better digital experience for everyone</p><br /><br />
